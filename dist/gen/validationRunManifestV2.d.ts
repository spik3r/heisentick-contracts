import { z } from 'zod';
export declare const validationRunManifestV2: z.ZodObject<{
    ...
    engine: z.ZodObject<{
        stratReleaseArtifact: z.ZodObject<{
            release: z.ZodString;
            assetName: z.ZodString;
            sha256: z.ZodString;
        }, z.core.$strict>;
        expectedLinkedModule: z.ZodObject<{
            modulePath: z.ZodLiteral<"github.com/spik3r/heisentick-strat">;
            release: z.ZodString;
            moduleSum: z.ZodString;
        }, z.core.$strict>;
...
export type ValidationRunManifestV2 = z.infer<typeof validationRunManifestV2>;
