...
export const MANIFEST_IDENTITY_FIELDS = ['runId', 'requestKey', 'requestedBy', 'submittedAt', 'inputFingerprint'];
export function inputFingerprint(manifest) {
    const inputs = {};
    for (const [key, value] of Object.entries(manifest)) {
        if (!MANIFEST_IDENTITY_FIELDS.includes(key))
            inputs[key] = value;
    }
